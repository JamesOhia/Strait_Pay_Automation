...
public class LoginBusinessTest extends CapabilitySetup {
    ...
    public void NullUserName() throws InterruptedException{
        ...
        try{
            loginPage.clickBusinessLogin();
            System.out.println("Business Login Button is clicked");
            test.log(Status.PASS, "Business Login Button is clicked");
        }
        catch(Exception e){
    ...
    public void loginValidCredentials() throws InterruptedException{
        String username = "christybrr1";
        String password = "QAT@2023";
